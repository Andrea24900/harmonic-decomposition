...
OM=25;
A = rotor_build.state_matrix_A_handles(0,OM);

%% Generation of data (snapshots) and SVD
delta_T = 1e-2;
time = (0:delta_T:1);
x_0 = ones(12,1);
[t,x] = ode45(@(t,x) odefun(t,x,A),time,x_0);
x=x';
...
time = (0:delta_T:10);
[t_2,x_2] = ode45(@(t,x) odefun(t,x,A),time,x_0);
x_2=x_2';
...
text(1.5,0.5, sprintf('FIT (all states) = %d percent', FIT_2),'FontSize',15)
xlabel('t')
ylabel('x_H')
