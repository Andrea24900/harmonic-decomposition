...
my_plot.plot_mod_part(modal_participation.modal_participation,8,7,...
    {'$\phi_{Z_{1c},5,n}$'},'XLimits',[50 400],'PlotSum',false)
...
my_plot.plot_mod_part(modal_participation.modal_participation,8,17,...
...
my_plot.plot_mod_part(modal_participation.modal_participation,8,31,...
    {'$\phi_{Z_{1c},16,n}$'},'XLimits',[50 400],'PlotSum',false)
%% second harmonic (modes from 37 to 60)
modes_to_plot_2c = 24*ones(1,12)+modes_to_plot_1c;

my_plot.plot_damping_order(modes.modal_solution,'Modes',modes_to_plot_2c)
my_plot.plot_mod_part(modal_participation.modal_participation,8,41,...
    {'$\phi_{Z_{1c},21,n}$'},'XLimits',[50 400],'PlotSum',false)
%%
modes_to_plot_2s = 48*ones(1,12)+modes_to_plot_0;

my_plot.plot_damping_order(modes.modal_solution,'Modes',modes_to_plot_2s)
my_plot.plot_mod_part(modal_participation.modal_participation,8,55,...
    {'$\phi_{Z_{1c},28,n}$'},'XLimits',[50 400],'PlotSum',false)

%% third harmonic (modes from 61 to 84)


% my_plot.plot_damping_order(modes.modal_solution,'Modes',modes_to_plot_0)
% my_plot.plot_mod_part(modal_participation.modal_participation,8,31,...
%     {'$\phi_{Z_{1c},31,n}$'},'XLimits',[50 400],'PlotSum',false)
% %%
% 
% 
% my_plot.plot_damping_order(modes.modal_solution,'Modes',modes_to_plot_0)
% my_plot.plot_mod_part(modal_participation.modal_participation,8,40,...
%     {'$\phi_{Z_{1c},40,n}$'},'XLimits',[50 400],'PlotSum',false)